...
class DataBaseHelper {
  ...
  String serverUrl = "http://192.168.0.122:8000/api";
  String serverUrlproducts = "http://192.168.0.122:8000/api/products";
...
void addDataProducto(String _nameController , String _priceController, String _stockController) async {
   ...
   String myUrl = "http://192.168.0.122:8000/api/products";
   final response = await  http.post(myUrl,
        headers: {
          'Accept':'application/json'
        },
  ...
  void editarData(String id, String name , String price, String stock) async {
    ...
    String myUrl = "http://192.168.0.122:8000/api/products/$id";
    http.put(myUrl,
        headers: {
          'Accept':'application/json',
